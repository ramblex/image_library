...
The gem assumes you will use Devise and Pundit. To enable authentication, add
the following to an initializer:

    ImageLibrary::UploadsController.class_eval do
